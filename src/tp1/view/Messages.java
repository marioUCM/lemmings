...
//Commands
	...
	// RESET
	public static final String INVALID_NUMBER ="Not valid level number";
	public static final String COMMAND_RESET_NAME = "reset";
	public static final String COMMAND_RESET_SHORTCUT = "r";
	public static final String COMMAND_RESET_DETAILS = "[r]eset [numLevel]";
	public static final String COMMAND_RESET_HELP = "reset the game to initial "
					+ "configuration if not numLevel else load the numLevel map";
	...
	public static final String PARACHUTER_ROL_SHORTCUT = "p";
	...
	public static final String DOWNCAVER_ROL_SHORTCUT = "dc";
